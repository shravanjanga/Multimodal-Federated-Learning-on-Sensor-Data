...
ROUND_CUT = {
    "Opp": {"single": 50, "cross": 50},
    "mHealth": {"single": 10, "cross": 25},
    "UR_Fall": {"single": 100, "cross": 100},
}
...
CB_color_cycle = ['#ff7f00', '#377eb8', '#f781bf', '#a65628', '#984ea3',
        ...
        for ae in aes[dataset]:
            for modalities in combo[dataset]:
                ...
                for k in schemes:
                    ...
                    se = stats.sem(data[:, METRIC_INDEX], nan_policy="omit")
                ...
                plt.savefig(f"plots/single_multi_modality_comparison_{dataset}_{ae}_{modalities[0]}_{modalities[1]}.pdf", bbox_inches="tight")
        ...
        for ae in aes[dataset]:
            for modalities in combo[dataset]:
                ...
                schemes_test_A = {
                    ...
                    "client_AB_label_AB_test_A": (1,"A0_B0_AB30_label_AB_test_A"),
                ...
                schemes_test_B = {
                    ...
                    "client_AB_label_AB_test_B": (1,"A0_B0_AB30_label_AB_test_B"),
                }
                legends = {
...
#                        continue
                    ...
                    rep_file = os.path.join("/Users/shravanjanga/iotdi22-mmfl/results", dataset.lower(), ae, f"{modalities[0]}_{modalities[1]}", schemes[k][1], "results.txt")
                    data = np.loadtxt(rep_file, delimiter=",")
                    x = data[:, 0]
                    y = data[:, METRIC_INDEX]
                    y[y == 0.0] = np.nan
                ...
                # ... existing code for setting labels, titles, saving the plot ...
                ...
                plt.savefig(f"plots/cross_modality_comparison_{dataset}_{ae}_{modalities[0]}_{modalities[1]}.pdf",
                    ...
                    # ... existing labels, title, legend setup ...
                
                # ... existing code to save plot ...
